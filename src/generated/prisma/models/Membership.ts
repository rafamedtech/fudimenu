...
export type MembershipOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"tenantId" | "userId" | "role" | "createdAt" | "updatedAt" | "deletedAt", ExtArgs["result"]["membership"]>
...
export interface MembershipDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
   ...
   * const membershipWithTenantIdOnly = await prisma.membership.findMany({ select: { tenantId: true } })
   * 
   */
   ...
   * })
   * 
   * // Create many Memberships and only return the `tenantId`
   * const membershipWithTenantIdOnly = await prisma.membership.createManyAndReturn({
   ...
   * })
   * 
   * // Update zero or more Memberships and only return the `tenantId`
   * const membershipWithTenantIdOnly = await prisma.membership.updateManyAndReturn({
   *   select: { tenantId: true },
   *   where: {
   *     // ... provide filter here
   *   },
